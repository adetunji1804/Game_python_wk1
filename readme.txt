...
Project: Dice roll game
    Aim: To refresh my python skills by using loop, function, class, object, list, dictionary list, exception
         and modules to create a simple interactive dice roll game.
...
Limitation: The max function to fetch the highest dice number from the list was not consistent fetching the
            highest number.